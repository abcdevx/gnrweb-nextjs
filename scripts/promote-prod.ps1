...
ssh gnr-hosting "cd /home/goodsmux/public_html/node_app && git fetch origin && git reset --hard origin/prod && rm -rf /home/goodsmux/public_html/node_app/.next/cache && rm -rf /home/goodsmux/lscache/* && ln -sfn /home/goodsmux/public_html/node_app/.next /home/goodsmux/public_html/_next && pkill -f 'public_html/node_app' && sleep 15 && curl -s -o /dev/null -w 'HTTP %{http_code}' https://goodnrowdy.com"
