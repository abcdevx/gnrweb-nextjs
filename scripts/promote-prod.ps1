...
ssh gnr-hosting "cd /home/goodsmux/public_html/node_app && git fetch origin && git reset --hard origin/prod && rm -rf /home/goodsmux/public_html/node_app/.next/cache && rm -rf /home/goodsmux/lscache/* && touch /home/goodsmux/public_html/tmp/restart.txt"
