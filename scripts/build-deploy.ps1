...
ssh gnr-hosting "cd /home/goodsmux/staging.goodnrowdy.com && git fetch origin && git reset --hard origin/staging && rm -rf .next/cache && touch tmp/restart.txt && sleep 5 && curl -s -o /dev/null -w 'HTTP %{http_code}' https://staging.goodnrowdy.com"
